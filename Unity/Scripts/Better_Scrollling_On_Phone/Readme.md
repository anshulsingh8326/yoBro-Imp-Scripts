---
title: Better Touch Scroll on Phone (Android, IOS)
updated: 2024-12-01 16:39:06Z
created: 2024-12-01 16:17:09Z
...
- Put the ***ScrollRect_Faster_Editor*** Script in Editor Folder in unity. ( Assets>Editor) ( or You can Create Editor Folder anywhere ).
- Put the ***ScrollRect_Faster*** Script in your script folder ( Anywhere, in any folder ).
- Now attach the ***ScrollRect_Faster*** Script on the Scroll Parent to create a Scroll Rect component. ( Remove the inbuilt Scroll Rect you were using previously ).
- Set Scroll Factor greater than 1 to see and feel the change. ( Ideally 1.5 gives native app feel ).

&nbsp;

♦ Original Code and Post : **[Here](https://discussions.unity.com/t/make-scrolling-move-faster-in-scrollrect/609651/21 "Link")**

♦ My Code : [**Here**](https://github.com/anshulsingh8326/yoBro-Imp-Scripts/tree/main)

&nbsp;

### <ins>**ScrollRect_Faster_Editor Script :**</ins>
...
{
    [CustomEditor(typeof(ScrollRect_Faster), true)]
    [CanEditMultipleObjects]
    public class ScrollRect_Faster_Editor : Editor
    {
        ...
        {
            SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)ScrollRect_Faster.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((ScrollRect_Faster)target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((ScrollRect_Faster.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == ScrollRect_Faster.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((ScrollRect_Faster.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == ScrollRect_Faster.ScrollbarVisibility.AutoHideAndExpandViewport
...
### <ins>**ScrollRect_Faster Script :**</ins>
...
namespace UnityEngine.UI
{
    ...
    public class ScrollRect_Faster : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
