...
• You Need 2 Scripts: ***ApplicationChrome.cs*** and ***ScreenSize.cs.***

• Call the ***ApplicationChrome.cs*** script function with in another script, ***ScreenSize.cs.***

***•*** For Desired Function calling in ***ScreenSize*** Script, Check Commented Syntax at Bottom . ( Call Any one Function, i.e : `ApplicationChrome.statusBarState = ApplicationChrome.navigationBarState = ApplicationChrome.States.Visible; //To have same background on status bar but not nav bar, Note : Keep Gameobjects little below, or it will overlap statusbar` ).

• This Code Author Link : [Here](https://gist.github.com/blevok/3dc5fec55a96b6f60ca24b49b4fcf98a)

• My Code Link : [Here](https://github.com/anshulsingh8326/yoBro-Imp-Scripts/tree/main/Unity/Scripts/Android_Remove_Fullscreen)

Links : 1. [ScreenSize Script](#screensizecs-script "#custom-anchor1")

&nbsp;          2. [Function Calling](#commented-syntax-for-desired-function "#custom-anchor2")

&nbsp;          3. [ApplicationChrome Script](# "#custom-anchor3")

### [](#)[](#)<span style="color: #3598db;">*<ins>**##ApplicationChrome.cs** **script :**</ins>*</span>
...
### [](#)[](#)<span style="color: #3598db;"><ins>***##ScreenSize.cs Script :***</ins></span>
...
### <span style="color: #3598db;"><ins>##**Commented Syntax For Desired Function :**</ins></span>
